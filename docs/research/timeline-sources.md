...
| 1970s-1980 | Later Survey of India one-inch editions ([Zenodo](https://zenodo.org/records/8388121)) | Surveyed outline and name | Sheets 57G and 57H, exact coverage unchecked | CC BY 4.0 | Medium |
| 1984-2024 | EC JRC Global Surface Water v1.5 ([download](https://global-surface-water.appspot.com/download)) | Yearly water, lakes over about 2 acres | Everywhere | Free | Low; we have 1984-2021 |
...
2. Trace the 1914-1917 and 1970s-1980 Survey of India sheets with the existing historic map pipeline.
...
CORONA and HEXAGON photos are the only per-lake record for 1955-1984 at pond scale, but each frame needs manual warping, so they come last.
